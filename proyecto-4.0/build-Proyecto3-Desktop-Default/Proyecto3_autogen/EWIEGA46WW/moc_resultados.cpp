...
#include "../../../Proyecto3/resultados.h"
...
struct qt_meta_stringdata_resultados_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_resultados_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_resultados_t qt_meta_stringdata_resultados = {
    {
QT_MOC_LITERAL(0, 0, 10), // "resultados"
QT_MOC_LITERAL(1, 11, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "resultados\0on_pushButton_clicked\0"
};
...
const QMetaObject resultados::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_resultados.data,
      qt_meta_data_resultados,  qt_static_metacall, nullptr, nullptr}
};
...
void *resultados::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_resultados.stringdata0))
